    ...
    while (1)
    {
        ...
        if (bytes_read > 0) {
            ...
            if (fft_input_index < FFT_N && sampling_devider == 7) {
                sampling_devider = 0;
                real_fft_plan->input[fft_input_index] = (float)(sample >> 16) / 32767.0f;  // normalize
                fft_input_index++;
            }
    ...
    if (fft_input_index == FFT_N) {
        ...
        for (int k = 1; k < real_fft_plan->size / 2; k++)
        {
            ...
            if (display_mode == 1) {
                ...
                if (x < 160) {
                    tft.drawPixel(x, y, mag_2_color(mag * 300));
                    x++;
                }
            }
            else {
                ...
                if (x < 160) {
                    ...
                    tft.drawFastVLine(x, 80 - (mag * 100) + 1, (mag * 100), mag_2_color(mag * 300));
                    x++;
                }
            }
